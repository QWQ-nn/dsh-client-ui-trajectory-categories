...
const src = readFileSync(fileURLToPath(new URL("./lib/client.js", import.meta.url)), "utf8")
  .replace("function startNodeDrag(e, key) {", "function startNodeDrag(e, key) { if (document && document.body) document.body.setAttribute('dbg-startdrag', String(key));")
  .replace("function moveNodeDrag(e) {", "function moveNodeDrag(e) { if (document && document.body) document.body.setAttribute('dbg-movedrag', '1');");
